...
$inline_styles_selectors = array(
  'a, .header-nav .menu > .menu-item.mega > .sub-menu > .menu-item > a:hover, .header-nav .menu > .menu-item.mega > .sub-menu > .menu-item > .sub-menu a:hover' => array(
    'color' => '_themename_accent_color'
  ),
  ':focus, .menu-button:focus' => array(
